...
HTTPS_PROXY=localhost:8888 kubectl -n default delete -f manifests/prometheus-service-sed.yaml
HTTPS_PROXY=localhost:8888 kubectl -n default delete -f manifests/rbac-setup.yaml
